...
let test_Self_Evaluated = fun () ->
    ...
    test 10 (expr_eq (execute_tag_parse_expression (Pair(Symbol("quote"),Pair(Pair(Char('c'), Pair(Number(Float(37392.39382)), 
                  Pair(Number(Int(37392)), Pair(String("this"), Pair(Bool(true), Nil))))),Nil)))) 
                  (execute_expected(Const(Sexpr(Pair(Char('c'), Pair(Number(Float(37392.39382)), Pair(Number(Int(37392)), 
                  Pair(String("this"), Pair(Bool(true), Nil))))))))));
    test 11 (expr_eq (execute_tag_parse_expression (Pair(Symbol("quote"),Pair(Char('#'),Pair(Char('x'),Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 12 (expr_eq (execute_tag_parse_expression (Pair(Symbol("quote"),Pair(Char('#'),Symbol("x"))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    ;;
...
let test_Lambda_Expressions = fun () ->
    ...
    test 17 (expr_eq (execute_tag_parse_expression (Pair(Symbol "lambda", Pair(Pair(Symbol "a", Nil), Nil))))
    (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
...
let test_Applications = fun () ->
    ...
    test 2 (expr_eq (execute_tag_parse_expression (Pair(Symbol "+", Pair(Number (Int 5), Nil)))) 
      (execute_expected(Applic(Var("+"),[Const(Sexpr(Number(Int 5)))]))));
    ...
    test 4 (expr_eq (execute_tag_parse_expression (Pair(Symbol "+", Pair(Number(Int 5), Pair(Number (Float 4.4), Nil)))))
      (execute_expected(Applic(Var("+"),[Const(Sexpr(Number(Int 5))); Const(Sexpr(Number(Float 4.4)))]))));
    ...
    test 10 (expr_eq (execute_tag_parse_expression (Pair(Symbol "+", Pair(Number(Int 5), Pair(Number (Int 4), Number (Int 2))))))
    (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
...
let test_Disjunctions = fun () ->
    ...
    test 8 (expr_eq (execute_tag_parse_expression (Pair(Symbol "or", Pair(Number (Int 54), Pair(Char 'j', Pair(String "do it", Nil)))))) 
      (execute_expected(Or([Const(Sexpr(Number (Int 54))); Const(Sexpr(Char 'j')); Const(Sexpr(String "do it"))]))));
    test 9 (expr_eq (execute_tag_parse_expression (Pair(Symbol "or", Pair(Pair(Symbol "+", Pair(Number(Int 5), Pair(Number (Int 4), Nil))), 
      Pair(Pair(Symbol "lambda", Pair(Pair(Symbol "a", Pair(Symbol "b", Nil)), Pair(Symbol "x", Nil))), 
        Pair(Pair(Symbol "if", Pair(Pair(Symbol "quote", Pair(Symbol "g", Nil)), Pair(Symbol "h", Nil))), Nil)))))) 
      (execute_expected(Or([Applic(Var("+"),[Const(Sexpr(Number(Int 5))); Const(Sexpr(Number(Int 4)))]); LambdaSimple(["a"; "b"],Var("x"));  
        If(Const(Sexpr(Symbol "g")),Var("h"),Const(Void))]))));
    test 10 (expr_eq (execute_tag_parse_expression (Pair(Symbol "or", Number (Int 54))))
    (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 11 (expr_eq (execute_tag_parse_expression (Pair(Symbol "or", Pair(Number (Int 54), Char 'j'))))
    (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    ;;
...
let test_Definitions = fun () ->
    ...
    test 20 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Symbol("vs")), Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Def(Var("func"),LambdaOpt([],"vs",Var("x"))))));
    test 21 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Symbol("vs")), Pair(Symbol "x",Pair(Symbol "y", Nil)))        ))) 
      (execute_expected(Def(Var("func"),LambdaOpt([],"vs",Seq([Var("x"); Var("y")]))))));
    test 22 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Symbol("vs")), 
      Pair(Symbol "x",Pair(Symbol "y",Pair(Symbol "z", Nil))))        ))) 
      (execute_expected(Def(Var("func"),LambdaOpt([],"vs",Seq([Var("x"); Var("y"); Var("z")]))))));
    ...
    test 32 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Symbol "func", Nil) ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 33 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Nil),  Nil) ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 34 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Nil),Pair(Symbol "x",Symbol "y")) )))
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    ...
    test 39 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", String "not_ok"), Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 40 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Pair(Symbol "h", Pair(Symbol "h", Nil))), 
      Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 41 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Pair(String "+", Nil)), Pair(Symbol "x", Nil))  )))
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 42 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Pair(Number(Int(4)), Pair(Symbol "b", Nil))), 
      Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 43 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Pair(Symbol "a", Pair(Number (Int 5), Nil))), 
      Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 44 (expr_eq (execute_tag_parse_expression (Pair(Symbol "define", Pair(Pair(Symbol "func", Pair(Symbol "a", Number (Int 5))), 
      Pair(Symbol "x", Nil))        ))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
...
let test_Assignments = fun () ->
    ...
    test 8 (expr_eq (execute_tag_parse_expression (Pair(Symbol "set!", Pair(String "var", Pair(Number (Int 5), Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 9 (expr_eq (execute_tag_parse_expression (Pair(Symbol "set!", Pair(Char 'c', Pair(String "hello", Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 10 (expr_eq (execute_tag_parse_expression (Pair(Symbol "set!", Pair(Number(Int(20)), Pair(Char '\r', Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    test 11 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "set!", Pair(Pair(Symbol("quote"),Pair(Char('#'),Nil)), Pair(Pair(Symbol("quote"),Pair(Char('#'),Nil)), Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 12 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "set!", Pair(Pair(Symbol "lambda", Pair(Pair(Symbol "a", Symbol "b"), Pair(Symbol "x", Nil))), 
        Pair(Pair(Symbol "lambda", Pair(Nil, Pair(Symbol "x", Nil))), Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
...
let test_Cond_Macro_Expansion = fun () ->
    ...
    test 16 (expr_eq (execute_tag_parse_expression
      (Pair(Symbol "cond", Pair(Pair(Symbol "else", Pair(Symbol "g", Pair(Symbol "hh", Nil))), Pair(Pair(Symbol "f", Pair(Symbol "g", Nil)), Nil)))))
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 17 (expr_eq (execute_tag_parse_expression
      (Pair(Symbol "cond", Pair(Pair(Symbol "else", Pair(Symbol "g", Nil)), Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), Nil)))))
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 18 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "cond", Pair(Pair(Symbol "else", Pair(Symbol "g", Pair(Symbol "hh", Nil))), 
        Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    ...
    test 23 (expr_eq (execute_tag_parse_expression (Pair(Symbol "cond", Pair(Pair(Symbol "f", Pair(Symbol "g", Nil)), 
      Pair(Pair(Symbol "else", Pair(Symbol "g", Pair(Symbol "hh", Nil))), Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), Nil)))))) 
    (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 24 (expr_eq (execute_tag_parse_expression (Pair(Symbol "cond", Pair(Pair(Symbol "f", Pair(Symbol "g", Pair(Symbol "hh", Nil))), 
      Pair(Pair(Symbol "else", Pair(Symbol "g", Pair(Symbol "hh", Nil))), Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), Nil)))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)


    test 25 (expr_eq (execute_tag_parse_expression (Pair(Symbol "cond", Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), 
      Pair(Pair(Symbol "else", Pair(Symbol "g", Pair(Symbol "hh", Nil))), Pair(Pair(Symbol "f", Pair(Symbol "g", Pair(Symbol "hh", Nil))), Nil)))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    ...
    test 30 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "cond", Pair(Pair(Symbol "else", Pair(Symbol "g", Nil)), Pair(Pair(Symbol "f", Pair(Pair(Symbol "lambda", 
        Pair(Symbol "s", Pair(Symbol "x", Nil))),Nil)), Nil))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    ...
    test 33 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "cond", Pair(Pair(Symbol "f", Pair(Pair(Symbol "lambda", Pair(Symbol "s", Pair(Symbol "x", Nil))),Nil)), 
        Pair(Pair(Symbol "else", Pair(Symbol "g", Nil)), Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), Nil)))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
    test 34 (expr_eq (execute_tag_parse_expression (Pair(Symbol "cond", Pair(Pair(Symbol "f", Pair(Symbol "=>", Pair(Symbol "g", Nil))), 
      Pair(Pair(Symbol "else", Pair(Symbol "g", Nil)), Pair(Pair(Symbol "f", Pair(Pair(Symbol "lambda", Pair(Symbol "s", Pair(Symbol "x", Nil))),Nil)), 
        Nil)))))) 
      (execute_expected(Var("test failed with X_syntax_error"))));
    (* Failed, fixed *)
...
let test_Let_Rec_Macro_Expansion = fun () ->
    ...
    test 1 (expr_eq (execute_tag_parse_expression (Pair(Symbol "letrec", Pair(Nil, Pair(Symbol "g", Nil))))) 
      (execute_expected(Applic(LambdaSimple([],Var("g")),[]))));
    test 2 (expr_eq (execute_tag_parse_expression (Pair(Symbol "letrec", Pair(Nil, Pair(Symbol "g", Pair(Symbol "f", Nil)))))) 
      (execute_expected(Applic(LambdaSimple([],Seq([Var("g"); Var("f")])),[])))); 
    test 3 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "letrec", Pair(Pair(Pair(Symbol "s", Pair(Number (Int 4), Nil)), Nil), Pair(Symbol "g", Pair(Symbol "f", Nil))))))
      (execute_expected(Applic(LambdaSimple(["s"],Seq([Set(Var("s"), Const(Sexpr(Number(Int(4))))); Var("g"); Var("f")])),
        [Const(Sexpr(Symbol "whatever"))]))));
    test 4 (expr_eq (execute_tag_parse_expression 
      (Pair(Symbol "letrec", Pair(Pair(Pair(Symbol "s", Pair(Number (Int 4), Nil)), Nil), Pair(Symbol "g", Pair(Symbol "f", Pair(Number (Int 3), Nil)))))))
      (execute_expected(Applic(LambdaSimple(["s"],Seq([Set(Var("s"), Const(Sexpr(Number(Int(4))))); Var("g"); Var("f"); Const(Sexpr(Number (Int 3)))])),
        [Const(Sexpr(Symbol "whatever"))]))));
