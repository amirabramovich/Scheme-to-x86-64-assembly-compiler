...
let c52 = (run_semantics (tag_parse_expression (read_sexpr "
(define mat-sca-mul
(lambda (x m)
...
let c53 =  (tag_parse_expression (read_sexpr "
(define +
...
let c58 = (run_semantics (tag_parse_expression (read_sexpr "
...
let c60 = (run_semantics (tag_parse_expression (read_sexpr "
(define x 1)
")));;

let c61 = (run_semantics (tag_parse_expression (read_sexpr "
(set! x 2)
")));;

let c62 = (run_semantics (tag_parse_expression (read_sexpr "
x
")));;