...
user_code:
	...
	push rax
	mov rax, const_tbl+1 ; mov rax, AddressInConstTable
	push rax
	push 1 ; parsing of operator below:
	;; update 6.1
	mov rdi, 1 ; store num args in rdi 
	...
	.create_opt_list0:
		...
		jmp .create_opt_list0

	.done_create_opt_list0:
	...
	mov rax, PVAR(0) ; mov rax, qword[rbp + 8 * (4 + minor)], pos (= minor) 
