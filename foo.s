...
MAKE_LITERAL_INT(1) ; my address is 30
...
user_code:
	...
	mov rax, const_tbl+65 ; mov rax, AddressInConstTable
	push rax
	mov rax, qword [fvar_tbl+22*WORD_SIZE] ; put fvar v in rax register
	push rax
	mov rcx, 2 ; number of arguments 
	push 2 ; parsing of operator below:
	mov rax, qword [fvar_tbl+33*WORD_SIZE] ; put fvar v in rax register
...
apply:
    ...
    mov qword[r15], 0 ;; init number 0 to push at first time
    mov rax, r15 ;; mov to rax for first time

    mov r13, const_tbl + 1  ;; for comp in loop
    ...
    push r10 ;; push car
    push rax ;; 0 in first time, and later, the result of function , from the 2 previous params 
...
; ;;;;.finish_push_elems:
    ...
    add rsp, 2 * 8 ;; 2 args * 8 , 8 is size of each param
