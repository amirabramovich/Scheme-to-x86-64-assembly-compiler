...
MAKE_LITERAL_STRING "cons" ; my address is 6
MAKE_LITERAL_STRING "x" ; my address is 19
MAKE_LITERAL_STRING "y" ; my address is 29
MAKE_LITERAL_STRING "a" ; my address is 39
MAKE_LITERAL_SYMBOL(const_tbl + 39) ; my address is 49
MAKE_LITERAL_STRING "b" ; my address is 58
MAKE_LITERAL_SYMBOL(const_tbl + 58) ; my address is 68
MAKE_LITERAL_STRING "c" ; my address is 77
MAKE_LITERAL_SYMBOL(const_tbl + 77) ; my address is 87
MAKE_LITERAL_STRING "d" ; my address is 96
MAKE_LITERAL_SYMBOL(const_tbl + 96) ; my address is 106
MAKE_LITERAL_STRING "eq?" ; my address is 115
MAKE_LITERAL_PAIR(const_tbl + 106, const_tbl + 1) ; my address is 127
MAKE_LITERAL_PAIR(const_tbl + 87, const_tbl + 127) ; my address is 144
MAKE_LITERAL_PAIR(const_tbl + 68, const_tbl + 144) ; my address is 161
MAKE_LITERAL_PAIR(const_tbl + 49, const_tbl + 161) ; my address is 178
...
user_code:
	...
	push rax ; push arg 
	mov rax, const_tbl + 68 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 49 ; Const 
	push rax ; push arg 
