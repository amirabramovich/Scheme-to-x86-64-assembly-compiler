...
MAKE_LITERAL_STRING "cdr" ; my address is 30
MAKE_LITERAL_STRING "l" ; my address is 42
MAKE_LITERAL_INT(1) ; my address is 52
MAKE_LITERAL_INT(0) ; my address is 61
MAKE_LITERAL_STRING "quote" ; my address is 70
MAKE_LITERAL_SYMBOL(const_tbl + 70) ; my address is 84
MAKE_LITERAL_STRING "a" ; my address is 93
MAKE_LITERAL_SYMBOL(const_tbl + 93) ; my address is 103
MAKE_LITERAL_PAIR(const_tbl + 103, const_tbl + 1) ; my address is 112
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 112) ; my address is 129
MAKE_LITERAL_PAIR(const_tbl + 129, const_tbl + 1) ; my address is 146
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 146) ; my address is 163
MAKE_LITERAL_PAIR(const_tbl + 163, const_tbl + 1) ; my address is 180
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 180) ; my address is 197
MAKE_LITERAL_PAIR(const_tbl + 197, const_tbl + 1) ; my address is 214
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 214) ; my address is 231
MAKE_LITERAL_PAIR(const_tbl + 231, const_tbl + 1) ; my address is 248
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 248) ; my address is 265
MAKE_LITERAL_PAIR(const_tbl + 265, const_tbl + 1) ; my address is 282
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 282) ; my address is 299
MAKE_LITERAL_PAIR(const_tbl + 299, const_tbl + 1) ; my address is 316
MAKE_LITERAL_PAIR(const_tbl + 84, const_tbl + 316) ; my address is 333
MAKE_LITERAL_STRING "cons" ; my address is 350
MAKE_LITERAL_STRING "quasiquote" ; my address is 363
MAKE_LITERAL_SYMBOL(const_tbl + 363) ; my address is 382
MAKE_LITERAL_STRING "length" ; my address is 391
MAKE_LITERAL_STRING "=" ; my address is 406
...
dq T_UNDEFINED ; i'm length, my address is 33
