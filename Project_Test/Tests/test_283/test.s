...
MAKE_LITERAL_STRING "=" ; my address is 24
MAKE_LITERAL_INT(1) ; my address is 34
MAKE_LITERAL_STRING "y" ; my address is 43
MAKE_LITERAL_STRING "x" ; my address is 53
MAKE_LITERAL_STRING "this should be an error, but you don't support exceptions" ; my address is 63
MAKE_LITERAL_STRING "length" ; my address is 129
MAKE_LITERAL_STRING "car" ; my address is 144
MAKE_LITERAL_STRING "null?" ; my address is 156
MAKE_LITERAL_STRING "make-vector" ; my address is 170
...
user_code:
	...
	.done_copy_env:
		...
		mov r15, rbp ; r15 = rbp
		add r15, 32 ; r15 = address of first arg
		MALLOC r14, 8*6 ; allocate ExtEnv[0]
		mov r11, r14 ; copy of ExtEnv[0] 

	.copy_params:
		cmp r12, 6 ; 6 arguments
		je .done_copy_params
		mov r9, [r15] ; r9 = Param(i)
		mov [r14], r9 ; ExtEnv [0][i] = r9
		add r14, 8
	...
	mov qword [fvar_tbl + 17 * WORD_SIZE], rax ; VarFree, Set 
	mov rax, SOB_VOID_ADDRESS
    call write_sob_if_not_void
	add rsp, 4*8 
	pop rbp 
