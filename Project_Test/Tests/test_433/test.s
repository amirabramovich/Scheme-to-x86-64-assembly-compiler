...
MAKE_LITERAL_SYMBOL(const_tbl + 6) ; my address is 19
MAKE_LITERAL_STRING "null?" ; my address is 28
MAKE_LITERAL_SYMBOL(const_tbl + 28) ; my address is 42
MAKE_LITERAL_STRING "pair?" ; my address is 51
MAKE_LITERAL_SYMBOL(const_tbl + 51) ; my address is 65
MAKE_LITERAL_STRING "append" ; my address is 74
MAKE_LITERAL_STRING "a" ; my address is 89
MAKE_LITERAL_SYMBOL(const_tbl + 89) ; my address is 99
MAKE_LITERAL_STRING "b" ; my address is 108
MAKE_LITERAL_SYMBOL(const_tbl + 108) ; my address is 118
MAKE_LITERAL_PAIR(const_tbl + 118, const_tbl + 1) ; my address is 127
MAKE_LITERAL_PAIR(const_tbl + 99, const_tbl + 127) ; my address is 144
MAKE_LITERAL_STRING "c" ; my address is 161
MAKE_LITERAL_SYMBOL(const_tbl + 161) ; my address is 171
...
user_code:
	mov rax, const_tbl + 19 ; Const 
	mov qword [fvar_tbl + 32 * WORD_SIZE], rax; Define 
	mov rax, SOB_VOID_ADDRESS
    call write_sob_if_not_void

	mov rax, const_tbl + 42 ; Const 
	mov qword [fvar_tbl + 4 * WORD_SIZE], rax; Define 
	mov rax, SOB_VOID_ADDRESS
    call write_sob_if_not_void

	mov rax, const_tbl + 65 ; Const 
	mov qword [fvar_tbl + 3 * WORD_SIZE], rax; Define 
	mov rax, SOB_VOID_ADDRESS
    call write_sob_if_not_void
