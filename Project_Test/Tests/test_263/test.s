...
MAKE_LITERAL_STRING "t" ; my address is 6
MAKE_LITERAL_STRING "apply" ; my address is 16
MAKE_LITERAL_STRING "foo" ; my address is 30
MAKE_LITERAL_INT(4) ; my address is 42
MAKE_LITERAL_INT(5) ; my address is 51
MAKE_LITERAL_INT(6) ; my address is 60
MAKE_LITERAL_INT(3) ; my address is 69
MAKE_LITERAL_INT(2) ; my address is 78
MAKE_LITERAL_INT(43) ; my address is 87
MAKE_LITERAL_INT(56) ; my address is 96
MAKE_LITERAL_INT(23) ; my address is 105
MAKE_LITERAL_INT(533) ; my address is 114
MAKE_LITERAL_PAIR(const_tbl + 42, const_tbl + 1) ; my address is 123
MAKE_LITERAL_PAIR(const_tbl + 69, const_tbl + 123) ; my address is 140
MAKE_LITERAL_INT(1) ; my address is 157
MAKE_LITERAL_PAIR(const_tbl + 69, const_tbl + 1) ; my address is 166
MAKE_LITERAL_PAIR(const_tbl + 78, const_tbl + 166) ; my address is 183
MAKE_LITERAL_PAIR(const_tbl + 157, const_tbl + 183) ; my address is 200
...
dq T_UNDEFINED ; i'm foo, my address is 33
