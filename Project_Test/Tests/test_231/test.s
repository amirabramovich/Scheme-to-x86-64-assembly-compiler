...
MAKE_LITERAL_STRING "set-cdr!" ; my address is 57
MAKE_LITERAL_STRING "car" ; my address is 74
MAKE_LITERAL_STRING "cdr" ; my address is 86
MAKE_LITERAL_STRING "apply" ; my address is 98
MAKE_LITERAL_STRING "cons" ; my address is 112
MAKE_LITERAL_STRING "foo" ; my address is 125
MAKE_LITERAL_STRING "a" ; my address is 137
MAKE_LITERAL_STRING "b" ; my address is 147
MAKE_LITERAL_STRING "c" ; my address is 157
MAKE_LITERAL_STRING "d" ; my address is 167
MAKE_LITERAL_STRING "e" ; my address is 177
MAKE_LITERAL_STRING "f" ; my address is 187
MAKE_LITERAL_STRING "g" ; my address is 197
MAKE_LITERAL_STRING "h" ; my address is 207
MAKE_LITERAL_STRING "i" ; my address is 217
MAKE_LITERAL_STRING "j" ; my address is 227
MAKE_LITERAL_STRING "k" ; my address is 237
MAKE_LITERAL_STRING "l" ; my address is 247
MAKE_LITERAL_STRING "m" ; my address is 257
MAKE_LITERAL_STRING "n" ; my address is 267
MAKE_LITERAL_STRING "o" ; my address is 277
MAKE_LITERAL_STRING "p" ; my address is 287
MAKE_LITERAL_STRING "q" ; my address is 297
MAKE_LITERAL_STRING "r" ; my address is 307
MAKE_LITERAL_STRING "s" ; my address is 317
MAKE_LITERAL_STRING "t" ; my address is 327
MAKE_LITERAL_STRING "u" ; my address is 337
MAKE_LITERAL_STRING "v" ; my address is 347
MAKE_LITERAL_STRING "w" ; my address is 357
MAKE_LITERAL_STRING "x" ; my address is 367
MAKE_LITERAL_STRING "y" ; my address is 377
MAKE_LITERAL_STRING "z" ; my address is 387
...
dq T_UNDEFINED ; i'm apply, my address is 35
...
user_code:
	...
	push rax ; push arg 
	mov rax, const_tbl + 367 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 357 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 347 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 337 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 327 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 317 ; Const 
	push rax ; push arg 
	...
	push rax ; push arg 
	mov rax, const_tbl + 277 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 267 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 257 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 247 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 237 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 227 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 217 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 207 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 197 ; Const 
	push rax ; push arg 
	...
	push rax ; push arg 
	mov rax, const_tbl + 157 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 147 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 137 ; Const 
	push rax ; push arg 
	push 26 ; push number args 
	; start parse op 
	mov rax, qword [fvar_tbl + 34 * WORD_SIZE] ; VarFree 
	; finish parse op 
 	mov rbx, [rax + TYPE_SIZE] ; closure's env to rbx 
