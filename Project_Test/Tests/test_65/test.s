...
MAKE_LITERAL_STRING "append" ; my address is 6
MAKE_LITERAL_INT(1) ; my address is 21
MAKE_LITERAL_INT(2) ; my address is 30
MAKE_LITERAL_PAIR(const_tbl + 30, const_tbl + 1) ; my address is 39
MAKE_LITERAL_PAIR(const_tbl + 21, const_tbl + 39) ; my address is 56
MAKE_LITERAL_INT(3) ; my address is 73
MAKE_LITERAL_INT(4) ; my address is 82
MAKE_LITERAL_PAIR(const_tbl + 82, const_tbl + 1) ; my address is 91
MAKE_LITERAL_PAIR(const_tbl + 73, const_tbl + 91) ; my address is 108
MAKE_LITERAL_PAIR(const_tbl + 108, const_tbl + 1) ; my address is 125
MAKE_LITERAL_PAIR(const_tbl + 56, const_tbl + 125) ; my address is 142
MAKE_LITERAL_INT(5) ; my address is 159
MAKE_LITERAL_INT(6) ; my address is 168
MAKE_LITERAL_PAIR(const_tbl + 168, const_tbl + 1) ; my address is 177
MAKE_LITERAL_PAIR(const_tbl + 159, const_tbl + 177) ; my address is 194
MAKE_LITERAL_INT(7) ; my address is 211
MAKE_LITERAL_INT(8) ; my address is 220
MAKE_LITERAL_PAIR(const_tbl + 220, const_tbl + 1) ; my address is 229
MAKE_LITERAL_PAIR(const_tbl + 211, const_tbl + 229) ; my address is 246
MAKE_LITERAL_PAIR(const_tbl + 246, const_tbl + 1) ; my address is 263
MAKE_LITERAL_PAIR(const_tbl + 194, const_tbl + 263) ; my address is 280
MAKE_LITERAL_INT(9) ; my address is 297
MAKE_LITERAL_INT(10) ; my address is 306
MAKE_LITERAL_PAIR(const_tbl + 306, const_tbl + 1) ; my address is 315
MAKE_LITERAL_PAIR(const_tbl + 297, const_tbl + 315) ; my address is 332
MAKE_LITERAL_STRING "quote" ; my address is 349
MAKE_LITERAL_SYMBOL(const_tbl + 349) ; my address is 363
MAKE_LITERAL_INT(11) ; my address is 372
MAKE_LITERAL_INT(12) ; my address is 381
MAKE_LITERAL_PAIR(const_tbl + 381, const_tbl + 1) ; my address is 390
MAKE_LITERAL_PAIR(const_tbl + 372, const_tbl + 390) ; my address is 407
MAKE_LITERAL_PAIR(const_tbl + 407, const_tbl + 1) ; my address is 424
MAKE_LITERAL_PAIR(const_tbl + 363, const_tbl + 424) ; my address is 441
MAKE_LITERAL_PAIR(const_tbl + 441, const_tbl + 1) ; my address is 458
MAKE_LITERAL_PAIR(const_tbl + 332, const_tbl + 458) ; my address is 475
MAKE_LITERAL_PAIR(const_tbl + 475, const_tbl + 1) ; my address is 492
...
dq T_UNDEFINED ; i'm append, my address is 33
