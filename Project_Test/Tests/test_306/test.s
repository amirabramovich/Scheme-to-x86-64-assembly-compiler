...
MAKE_LITERAL_PAIR(const_tbl + 24, const_tbl + 1) ; my address is 33
MAKE_LITERAL_PAIR(const_tbl + 15, const_tbl + 33) ; my address is 50
MAKE_LITERAL_PAIR(const_tbl + 6, const_tbl + 50) ; my address is 67
MAKE_LITERAL_PAIR(const_tbl + 15, const_tbl + 1) ; my address is 84
MAKE_LITERAL_PAIR(const_tbl + 6, const_tbl + 84) ; my address is 101
MAKE_LITERAL_PAIR(const_tbl + 6, const_tbl + 101) ; my address is 118
MAKE_LITERAL_STRING "lst" ; my address is 135
MAKE_LITERAL_STRING "hello" ; my address is 147
MAKE_LITERAL_STRING "quote" ; my address is 161
MAKE_LITERAL_SYMBOL(const_tbl + 161) ; my address is 175
MAKE_LITERAL_STRING "bye" ; my address is 184
MAKE_LITERAL_SYMBOL(const_tbl + 184) ; my address is 196
MAKE_LITERAL_PAIR(const_tbl + 196, const_tbl + 1) ; my address is 205
MAKE_LITERAL_PAIR(const_tbl + 175, const_tbl + 205) ; my address is 222
MAKE_LITERAL_STRING "helloa" ; my address is 239
MAKE_LITERAL_PAIR(const_tbl + 239, const_tbl + 1) ; my address is 254
MAKE_LITERAL_PAIR(const_tbl + 222, const_tbl + 254) ; my address is 271
MAKE_LITERAL_PAIR(const_tbl + 147, const_tbl + 271) ; my address is 288
MAKE_LITERAL_PAIR(const_tbl + 184, const_tbl + 1) ; my address is 305
MAKE_LITERAL_STRING "lst2" ; my address is 322
MAKE_LITERAL_FLOAT(1.5) ; my address is 335
MAKE_LITERAL_PAIR(const_tbl + 335, const_tbl + 50) ; my address is 344
MAKE_LITERAL_PAIR(const_tbl + 344, const_tbl + 101) ; my address is 361
MAKE_LITERAL_INT(4) ; my address is 378
MAKE_LITERAL_STRING "lst3" ; my address is 387
MAKE_LITERAL_STRING "a" ; my address is 400
MAKE_LITERAL_SYMBOL(const_tbl + 400) ; my address is 410
MAKE_LITERAL_PAIR(const_tbl + 410, const_tbl + 1) ; my address is 419
MAKE_LITERAL_PAIR(const_tbl + 175, const_tbl + 419) ; my address is 436
MAKE_LITERAL_VECTOR const_tbl + 6, const_tbl + 436 ; my address is 453
MAKE_LITERAL_PAIR(const_tbl + 453, const_tbl + 50) ; my address is 478
MAKE_LITERAL_STRING "set-cdr!" ; my address is 495
MAKE_LITERAL_STRING "cdr" ; my address is 512
MAKE_LITERAL_STRING "lst4" ; my address is 524
...
dq T_UNDEFINED ; i'm lst4, my address is 33
dq T_UNDEFINED ; i'm lst3, my address is 34
dq T_UNDEFINED ; i'm lst2, my address is 35
dq T_UNDEFINED ; i'm lst, my address is 36
