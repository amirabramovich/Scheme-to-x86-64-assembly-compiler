...
MAKE_LITERAL_INT(0) ; my address is 30
MAKE_LITERAL_STRING "car" ; my address is 39
MAKE_LITERAL_STRING "cdr" ; my address is 51
MAKE_LITERAL_STRING "lst" ; my address is 63
MAKE_LITERAL_STRING "-" ; my address is 75
MAKE_LITERAL_STRING "n" ; my address is 85
MAKE_LITERAL_INT(1) ; my address is 95
MAKE_LITERAL_INT(2) ; my address is 104
MAKE_LITERAL_INT(3) ; my address is 113
MAKE_LITERAL_INT(4) ; my address is 122
MAKE_LITERAL_INT(5) ; my address is 131
MAKE_LITERAL_PAIR(const_tbl + 131, const_tbl + 1) ; my address is 140
MAKE_LITERAL_PAIR(const_tbl + 122, const_tbl + 140) ; my address is 157
MAKE_LITERAL_PAIR(const_tbl + 113, const_tbl + 157) ; my address is 174
MAKE_LITERAL_PAIR(const_tbl + 104, const_tbl + 174) ; my address is 191
MAKE_LITERAL_PAIR(const_tbl + 95, const_tbl + 191) ; my address is 208
MAKE_LITERAL_STRING "get-nth" ; my address is 225
MAKE_LITERAL_PAIR(const_tbl + 113, const_tbl + 1) ; my address is 241
MAKE_LITERAL_PAIR(const_tbl + 104, const_tbl + 241) ; my address is 258
MAKE_LITERAL_PAIR(const_tbl + 95, const_tbl + 258) ; my address is 275
MAKE_LITERAL_INT(8) ; my address is 292
...
dq T_UNDEFINED ; i'm get-nth, my address is 33
