...
MAKE_LITERAL_STRING "list->vector" ; my address is 6
MAKE_LITERAL_INT(1) ; my address is 27
MAKE_LITERAL_STRING "quote" ; my address is 36
MAKE_LITERAL_SYMBOL(const_tbl + 36) ; my address is 50
MAKE_LITERAL_STRING "hello" ; my address is 59
MAKE_LITERAL_SYMBOL(const_tbl + 59) ; my address is 73
MAKE_LITERAL_PAIR(const_tbl + 73, const_tbl + 1) ; my address is 82
MAKE_LITERAL_PAIR(const_tbl + 50, const_tbl + 82) ; my address is 99
MAKE_LITERAL_PAIR(const_tbl + 99, const_tbl + 1) ; my address is 116
MAKE_LITERAL_PAIR(const_tbl + 27, const_tbl + 116) ; my address is 133
MAKE_LITERAL_STRING "vector->list" ; my address is 150
...
dq T_UNDEFINED ; i'm list->vector, my address is 34
