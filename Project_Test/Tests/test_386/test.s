...
MAKE_LITERAL_STRING "cddr" ; my address is 127
MAKE_LITERAL_STRING "pair" ; my address is 140
MAKE_LITERAL_STRING "cdr" ; my address is 153
MAKE_LITERAL_STRING "cdddr" ; my address is 165
MAKE_LITERAL_STRING "-" ; my address is 179
MAKE_LITERAL_STRING "char->integer" ; my address is 189
MAKE_LITERAL_STRING "c" ; my address is 211
MAKE_LITERAL_STRING "+" ; my address is 221
MAKE_LITERAL_INT(32) ; my address is 231
MAKE_LITERAL_STRING "integer->char" ; my address is 240
MAKE_LITERAL_CHAR('a') ; my address is 262
MAKE_LITERAL_STRING "char-upcase" ; my address is 264
MAKE_LITERAL_CHAR('r') ; my address is 284
MAKE_LITERAL_STRING "char-downcase" ; my address is 286
MAKE_LITERAL_CHAR('A') ; my address is 308
...
dq T_UNDEFINED ; i'm char-downcase, my address is 33
dq T_UNDEFINED ; i'm char-upcase, my address is 34
...
user_code:
	...
	push 1 ; push number args 
	; start parse op 
	mov rax, qword [fvar_tbl + 20 * WORD_SIZE] ; VarFree 
	; finish parse op 
 	mov rbx, [rax + TYPE_SIZE] ; closure's env to rbx 
	push rbx ; push env (args) to stack (rsp stack pointer) 
	mov rbx, [rax + TYPE_SIZE + WORD_SIZE] ; clousre's code to rbx 
