...
MAKE_LITERAL_STRING "y1" ; my address is 6
MAKE_LITERAL_SYMBOL(const_tbl + 6) ; my address is 17
MAKE_LITERAL_PAIR(const_tbl + 17, const_tbl + 1) ; my address is 26
MAKE_LITERAL_STRING "y2" ; my address is 43
MAKE_LITERAL_SYMBOL(const_tbl + 43) ; my address is 54
MAKE_LITERAL_PAIR(const_tbl + 54, const_tbl + 1) ; my address is 63
MAKE_LITERAL_PAIR(const_tbl + 17, const_tbl + 63) ; my address is 80
MAKE_LITERAL_STRING "y3" ; my address is 97
MAKE_LITERAL_SYMBOL(const_tbl + 97) ; my address is 108
MAKE_LITERAL_PAIR(const_tbl + 108, const_tbl + 1) ; my address is 117
MAKE_LITERAL_PAIR(const_tbl + 54, const_tbl + 117) ; my address is 134
MAKE_LITERAL_PAIR(const_tbl + 17, const_tbl + 134) ; my address is 151
MAKE_LITERAL_STRING "y4" ; my address is 168
MAKE_LITERAL_SYMBOL(const_tbl + 168) ; my address is 179
MAKE_LITERAL_PAIR(const_tbl + 179, const_tbl + 1) ; my address is 188
MAKE_LITERAL_PAIR(const_tbl + 108, const_tbl + 188) ; my address is 205
MAKE_LITERAL_PAIR(const_tbl + 54, const_tbl + 205) ; my address is 222
MAKE_LITERAL_PAIR(const_tbl + 17, const_tbl + 222) ; my address is 239
MAKE_LITERAL_STRING "y5" ; my address is 256
MAKE_LITERAL_SYMBOL(const_tbl + 256) ; my address is 267
MAKE_LITERAL_PAIR(const_tbl + 267, const_tbl + 1) ; my address is 276
MAKE_LITERAL_PAIR(const_tbl + 179, const_tbl + 276) ; my address is 293
MAKE_LITERAL_PAIR(const_tbl + 108, const_tbl + 293) ; my address is 310
MAKE_LITERAL_PAIR(const_tbl + 54, const_tbl + 310) ; my address is 327
MAKE_LITERAL_PAIR(const_tbl + 17, const_tbl + 327) ; my address is 344
MAKE_LITERAL_STRING "x1" ; my address is 361
MAKE_LITERAL_STRING "x2" ; my address is 372
MAKE_LITERAL_STRING "x3" ; my address is 383
MAKE_LITERAL_STRING "x4" ; my address is 394
MAKE_LITERAL_STRING "x5" ; my address is 405
MAKE_LITERAL_STRING "x6" ; my address is 416
MAKE_LITERAL_INT(1) ; my address is 427
MAKE_LITERAL_INT(2) ; my address is 436
MAKE_LITERAL_INT(3) ; my address is 445
MAKE_LITERAL_INT(4) ; my address is 454
MAKE_LITERAL_INT(5) ; my address is 463
