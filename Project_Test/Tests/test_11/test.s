...
MAKE_LITERAL_INT(5) ; my address is 6
MAKE_LITERAL_FLOAT(5.5) ; my address is 15
MAKE_LITERAL_CHAR('h') ; my address is 24
MAKE_LITERAL_STRING " hello this is the final project" ; my address is 26
MAKE_LITERAL_STRING "hellothisisthefinalproject12345678910" ; my address is 67
MAKE_LITERAL_SYMBOL(const_tbl + 67) ; my address is 113
MAKE_LITERAL_INT(55) ; my address is 122
MAKE_LITERAL_FLOAT(4.4) ; my address is 131
MAKE_LITERAL_STRING "gotcha" ; my address is 140
MAKE_LITERAL_CHAR('	') ; my address is 155
MAKE_LITERAL_PAIR(const_tbl + 155, const_tbl + 1) ; my address is 157
MAKE_LITERAL_PAIR(const_tbl + 2, const_tbl + 157) ; my address is 174
MAKE_LITERAL_PAIR(const_tbl + 4, const_tbl + 174) ; my address is 191
MAKE_LITERAL_PAIR(const_tbl + 140, const_tbl + 191) ; my address is 208
MAKE_LITERAL_PAIR(const_tbl + 131, const_tbl + 208) ; my address is 225
MAKE_LITERAL_PAIR(const_tbl + 122, const_tbl + 225) ; my address is 242
MAKE_LITERAL_VECTOR const_tbl + 122, const_tbl + 131, const_tbl + 140, const_tbl + 4, const_tbl + 2, const_tbl + 155 ; my address is 259
...
user_code:
	...
	mov rax, const_tbl + 113 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 259 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 242 ; Const 
    call write_sob_if_not_void
	add rsp, 4*8 
	pop rbp 
	ret 
