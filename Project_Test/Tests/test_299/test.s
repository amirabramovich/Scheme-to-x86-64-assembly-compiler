...
MAKE_LITERAL_STRING "cons" ; my address is 32
MAKE_LITERAL_STRING "cdr" ; my address is 45
MAKE_LITERAL_STRING "lst" ; my address is 57
MAKE_LITERAL_STRING "pred" ; my address is 69
MAKE_LITERAL_STRING "pair?" ; my address is 82
MAKE_LITERAL_STRING "quote" ; my address is 96
MAKE_LITERAL_SYMBOL(const_tbl + 96) ; my address is 110
MAKE_LITERAL_INT(1) ; my address is 119
MAKE_LITERAL_INT(2) ; my address is 128
MAKE_LITERAL_PAIR(const_tbl + 128, const_tbl + 1) ; my address is 137
MAKE_LITERAL_PAIR(const_tbl + 119, const_tbl + 137) ; my address is 154
MAKE_LITERAL_PAIR(const_tbl + 154, const_tbl + 1) ; my address is 171
MAKE_LITERAL_PAIR(const_tbl + 110, const_tbl + 171) ; my address is 188
MAKE_LITERAL_INT(3) ; my address is 205
MAKE_LITERAL_INT(4) ; my address is 214
MAKE_LITERAL_PAIR(const_tbl + 214, const_tbl + 1) ; my address is 223
MAKE_LITERAL_PAIR(const_tbl + 205, const_tbl + 223) ; my address is 240
MAKE_LITERAL_PAIR(const_tbl + 188, const_tbl + 240) ; my address is 257
MAKE_LITERAL_STRING "filter" ; my address is 274
MAKE_LITERAL_STRING "vector?" ; my address is 289
MAKE_LITERAL_VECTOR const_tbl + 119 ; my address is 305
MAKE_LITERAL_PAIR(const_tbl + 305, const_tbl + 1) ; my address is 322
MAKE_LITERAL_PAIR(const_tbl + 110, const_tbl + 322) ; my address is 339
MAKE_LITERAL_FLOAT(1.5) ; my address is 356
MAKE_LITERAL_VECTOR const_tbl + 205 ; my address is 365
MAKE_LITERAL_PAIR(const_tbl + 365, const_tbl + 1) ; my address is 382
MAKE_LITERAL_PAIR(const_tbl + 110, const_tbl + 382) ; my address is 399
MAKE_LITERAL_PAIR(const_tbl + 399, const_tbl + 1) ; my address is 416
MAKE_LITERAL_PAIR(const_tbl + 128, const_tbl + 416) ; my address is 433
MAKE_LITERAL_PAIR(const_tbl + 356, const_tbl + 433) ; my address is 450
MAKE_LITERAL_PAIR(const_tbl + 339, const_tbl + 450) ; my address is 467
...
dq T_UNDEFINED ; i'm filter, my address is 33
