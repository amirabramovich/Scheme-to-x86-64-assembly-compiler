...
MAKE_LITERAL_STRING "null?" ; my address is 155
MAKE_LITERAL_STRING "car" ; my address is 169
MAKE_LITERAL_STRING "eq?" ; my address is 181
MAKE_LITERAL_STRING "b" ; my address is 193
MAKE_LITERAL_SYMBOL(const_tbl + 193) ; my address is 203
MAKE_LITERAL_STRING "c" ; my address is 212
MAKE_LITERAL_SYMBOL(const_tbl + 212) ; my address is 222
MAKE_LITERAL_STRING "a" ; my address is 231
MAKE_LITERAL_SYMBOL(const_tbl + 231) ; my address is 241
MAKE_LITERAL_STRING "d" ; my address is 250
MAKE_LITERAL_SYMBOL(const_tbl + 250) ; my address is 260
MAKE_LITERAL_STRING "e" ; my address is 269
MAKE_LITERAL_SYMBOL(const_tbl + 269) ; my address is 279
MAKE_LITERAL_PAIR(const_tbl + 279, const_tbl + 1) ; my address is 288
MAKE_LITERAL_PAIR(const_tbl + 260, const_tbl + 288) ; my address is 305
MAKE_LITERAL_PAIR(const_tbl + 241, const_tbl + 305) ; my address is 322
MAKE_LITERAL_PAIR(const_tbl + 222, const_tbl + 322) ; my address is 339
MAKE_LITERAL_PAIR(const_tbl + 203, const_tbl + 339) ; my address is 356
MAKE_LITERAL_STRING "g" ; my address is 373
MAKE_LITERAL_SYMBOL(const_tbl + 373) ; my address is 383
MAKE_LITERAL_PAIR(const_tbl + 383, const_tbl + 1) ; my address is 392
MAKE_LITERAL_PAIR(const_tbl + 279, const_tbl + 392) ; my address is 409
MAKE_LITERAL_PAIR(const_tbl + 260, const_tbl + 409) ; my address is 426
MAKE_LITERAL_PAIR(const_tbl + 222, const_tbl + 426) ; my address is 443
MAKE_LITERAL_PAIR(const_tbl + 203, const_tbl + 443) ; my address is 460
MAKE_LITERAL_STRING "f" ; my address is 477
MAKE_LITERAL_STRING "rest" ; my address is 487
MAKE_LITERAL_STRING "value" ; my address is 500
MAKE_LITERAL_STRING "memq" ; my address is 514
MAKE_LITERAL_STRING "cdr" ; my address is 527
MAKE_LITERAL_STRING "ls" ; my address is 539
MAKE_LITERAL_STRING "x" ; my address is 550
MAKE_LITERAL_STRING "+" ; my address is 560
MAKE_LITERAL_INT(1) ; my address is 570
MAKE_LITERAL_INT(0) ; my address is 579
MAKE_LITERAL_STRING "count-occurrences" ; my address is 588
MAKE_LITERAL_PAIR(const_tbl + 241, const_tbl + 1) ; my address is 614
MAKE_LITERAL_PAIR(const_tbl + 260, const_tbl + 614) ; my address is 631
MAKE_LITERAL_PAIR(const_tbl + 222, const_tbl + 631) ; my address is 648
MAKE_LITERAL_PAIR(const_tbl + 203, const_tbl + 648) ; my address is 665
MAKE_LITERAL_PAIR(const_tbl + 241, const_tbl + 665) ; my address is 682
...
dq T_UNDEFINED ; i'm count-occurrences, my address is 33
dq T_UNDEFINED ; i'm memq, my address is 34
dq T_UNDEFINED ; i'm cdddr, my address is 35
dq T_UNDEFINED ; i'm cddar, my address is 36
dq T_UNDEFINED ; i'm cdadr, my address is 37
dq T_UNDEFINED ; i'm cdaar, my address is 38
dq T_UNDEFINED ; i'm caadr, my address is 39
dq T_UNDEFINED ; i'm caaar, my address is 40
dq T_UNDEFINED ; i'm cdar, my address is 41
dq T_UNDEFINED ; i'm cddr, my address is 42
dq T_UNDEFINED ; i'm cadr, my address is 43
dq T_UNDEFINED ; i'm caar, my address is 44
...
user_code:
	...
	push 1 ; push number args 
	; start parse op 
	mov rax, qword [fvar_tbl + 44 * WORD_SIZE] ; VarFree 
	; finish parse op 
 	mov rbx, [rax + TYPE_SIZE] ; closure's env to rbx 
	push rbx ; push env (args) to stack (rsp stack pointer) 
	mov rbx, [rax + TYPE_SIZE + WORD_SIZE] ; clousre's code to rbx 
	...
	mov rax, MAGIC ; Applic 
	push rax ; push magic to stack 
	mov rax, const_tbl + 356 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 241 ; Const 
	push rax ; push arg 
	push 2 ; push number args 
	; start parse op 
	mov rax, qword [fvar_tbl + 34 * WORD_SIZE] ; VarFree 
