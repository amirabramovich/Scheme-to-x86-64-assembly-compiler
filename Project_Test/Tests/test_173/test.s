...
MAKE_LITERAL_STRING "map" ; my address is 6
MAKE_LITERAL_STRING "list" ; my address is 18
MAKE_LITERAL_STRING "a" ; my address is 31
MAKE_LITERAL_STRING "b" ; my address is 41
MAKE_LITERAL_STRING "c" ; my address is 51
MAKE_LITERAL_PAIR(const_tbl + 51, const_tbl + 1) ; my address is 61
MAKE_LITERAL_PAIR(const_tbl + 41, const_tbl + 61) ; my address is 78
MAKE_LITERAL_PAIR(const_tbl + 31, const_tbl + 78) ; my address is 95
MAKE_LITERAL_STRING "quote" ; my address is 112
MAKE_LITERAL_SYMBOL(const_tbl + 112) ; my address is 126
MAKE_LITERAL_SYMBOL(const_tbl + 31) ; my address is 135
MAKE_LITERAL_PAIR(const_tbl + 135, const_tbl + 1) ; my address is 144
MAKE_LITERAL_PAIR(const_tbl + 126, const_tbl + 144) ; my address is 161
MAKE_LITERAL_SYMBOL(const_tbl + 41) ; my address is 178
MAKE_LITERAL_PAIR(const_tbl + 178, const_tbl + 1) ; my address is 187
MAKE_LITERAL_PAIR(const_tbl + 126, const_tbl + 187) ; my address is 204
MAKE_LITERAL_SYMBOL(const_tbl + 51) ; my address is 221
MAKE_LITERAL_PAIR(const_tbl + 221, const_tbl + 1) ; my address is 230
MAKE_LITERAL_PAIR(const_tbl + 126, const_tbl + 230) ; my address is 247
MAKE_LITERAL_PAIR(const_tbl + 247, const_tbl + 1) ; my address is 264
MAKE_LITERAL_PAIR(const_tbl + 204, const_tbl + 264) ; my address is 281
MAKE_LITERAL_PAIR(const_tbl + 161, const_tbl + 281) ; my address is 298
MAKE_LITERAL_INT(1) ; my address is 315
MAKE_LITERAL_INT(2) ; my address is 324
MAKE_LITERAL_INT(3) ; my address is 333
MAKE_LITERAL_PAIR(const_tbl + 333, const_tbl + 1) ; my address is 342
MAKE_LITERAL_PAIR(const_tbl + 324, const_tbl + 342) ; my address is 359
MAKE_LITERAL_PAIR(const_tbl + 315, const_tbl + 359) ; my address is 376
MAKE_LITERAL_FLOAT(0.5) ; my address is 393
MAKE_LITERAL_FLOAT(0.333) ; my address is 402
MAKE_LITERAL_FLOAT(0.25) ; my address is 411
MAKE_LITERAL_PAIR(const_tbl + 411, const_tbl + 1) ; my address is 420
MAKE_LITERAL_PAIR(const_tbl + 402, const_tbl + 420) ; my address is 437
MAKE_LITERAL_PAIR(const_tbl + 393, const_tbl + 437) ; my address is 454
...
dq T_UNDEFINED ; i'm map, my address is 33
dq T_UNDEFINED ; i'm list, my address is 34
...
user_code:
	...
	push rax ; push arg 
	mov rax, const_tbl + 376 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 298 ; Const 
	push rax ; push arg 
