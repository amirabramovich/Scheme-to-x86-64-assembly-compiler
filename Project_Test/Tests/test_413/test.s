...
MAKE_LITERAL_STRING "-" ; my address is 16
MAKE_LITERAL_STRING "*" ; my address is 26
MAKE_LITERAL_STRING "/" ; my address is 36
MAKE_LITERAL_STRING "x" ; my address is 46
MAKE_LITERAL_STRING "list" ; my address is 56
MAKE_LITERAL_STRING "map" ; my address is 69
MAKE_LITERAL_INT(1) ; my address is 81
MAKE_LITERAL_INT(2) ; my address is 90
MAKE_LITERAL_PAIR(const_tbl + 90, const_tbl + 1) ; my address is 99
MAKE_LITERAL_PAIR(const_tbl + 81, const_tbl + 99) ; my address is 116
MAKE_LITERAL_INT(3) ; my address is 133
MAKE_LITERAL_INT(4) ; my address is 142
MAKE_LITERAL_PAIR(const_tbl + 142, const_tbl + 1) ; my address is 151
MAKE_LITERAL_PAIR(const_tbl + 133, const_tbl + 151) ; my address is 168
MAKE_LITERAL_FLOAT(5.) ; my address is 185
MAKE_LITERAL_FLOAT(6.) ; my address is 194
MAKE_LITERAL_PAIR(const_tbl + 194, const_tbl + 1) ; my address is 203
MAKE_LITERAL_PAIR(const_tbl + 185, const_tbl + 203) ; my address is 220
MAKE_LITERAL_FLOAT(16.) ; my address is 237
MAKE_LITERAL_FLOAT(8.) ; my address is 246
MAKE_LITERAL_PAIR(const_tbl + 246, const_tbl + 1) ; my address is 255
MAKE_LITERAL_PAIR(const_tbl + 237, const_tbl + 255) ; my address is 272
MAKE_LITERAL_PAIR(const_tbl + 272, const_tbl + 1) ; my address is 289
MAKE_LITERAL_PAIR(const_tbl + 220, const_tbl + 289) ; my address is 306
MAKE_LITERAL_PAIR(const_tbl + 168, const_tbl + 306) ; my address is 323
MAKE_LITERAL_PAIR(const_tbl + 116, const_tbl + 323) ; my address is 340
