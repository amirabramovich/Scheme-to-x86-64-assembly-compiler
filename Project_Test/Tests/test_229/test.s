...
MAKE_LITERAL_STRING "car" ; my address is 57
MAKE_LITERAL_STRING "cdr" ; my address is 69
MAKE_LITERAL_STRING "apply" ; my address is 81
MAKE_LITERAL_STRING "cons" ; my address is 95
MAKE_LITERAL_STRING "foo" ; my address is 108
MAKE_LITERAL_STRING "a" ; my address is 120
MAKE_LITERAL_STRING "b" ; my address is 130
MAKE_LITERAL_STRING "c" ; my address is 140
MAKE_LITERAL_STRING "d" ; my address is 150
MAKE_LITERAL_STRING "e" ; my address is 160
MAKE_LITERAL_STRING "f" ; my address is 170
MAKE_LITERAL_STRING "g" ; my address is 180
MAKE_LITERAL_STRING "h" ; my address is 190
MAKE_LITERAL_STRING "i" ; my address is 200
MAKE_LITERAL_STRING "j" ; my address is 210
MAKE_LITERAL_STRING "k" ; my address is 220
MAKE_LITERAL_STRING "l" ; my address is 230
MAKE_LITERAL_STRING "m" ; my address is 240
MAKE_LITERAL_STRING "n" ; my address is 250
MAKE_LITERAL_STRING "o" ; my address is 260
MAKE_LITERAL_STRING "p" ; my address is 270
MAKE_LITERAL_STRING "q" ; my address is 280
MAKE_LITERAL_STRING "r" ; my address is 290
MAKE_LITERAL_STRING "s" ; my address is 300
MAKE_LITERAL_STRING "t" ; my address is 310
MAKE_LITERAL_STRING "u" ; my address is 320
MAKE_LITERAL_STRING "v" ; my address is 330
MAKE_LITERAL_STRING "w" ; my address is 340
MAKE_LITERAL_STRING "x" ; my address is 350
MAKE_LITERAL_STRING "y" ; my address is 360
MAKE_LITERAL_STRING "z" ; my address is 370
...
user_code:
	...
	mov rax, MAGIC ; Applic 
	push rax ; push magic to stack 
	mov rax, const_tbl + 370 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 360 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 350 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 340 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 330 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 320 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 310 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 300 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 290 ; Const 
	push rax ; push arg 
	...
	push rax ; push arg 
	mov rax, const_tbl + 250 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 240 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 230 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 220 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 210 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 200 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 190 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 180 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 170 ; Const 
	push rax ; push arg 
