...
MAKE_LITERAL_INT(33455) ; my address is 6
MAKE_LITERAL_STRING " 
 	                             
  hello                    " ; my address is 15
MAKE_LITERAL_INT(58687942) ; my address is 88
MAKE_LITERAL_STRING "k dfldsfdsk l4lgb gflfdgl" ; my address is 97
MAKE_LITERAL_INT(44654) ; my address is 131
MAKE_LITERAL_INT(5) ; my address is 140
MAKE_LITERAL_STRING " 
 	                             
  hello                
 	  
 dfdsfds 445 fgfdgfd    " ; my address is 149
MAKE_LITERAL_STRING "dfdfdsfhgfdhd4gfdggfgdf" ; my address is 249
MAKE_LITERAL_SYMBOL(const_tbl + 249) ; my address is 281
MAKE_LITERAL_STRING "fgfdgf" ; my address is 290
MAKE_LITERAL_SYMBOL(const_tbl + 290) ; my address is 305
MAKE_LITERAL_INT(6) ; my address is 314
MAKE_LITERAL_INT(7) ; my address is 323
MAKE_LITERAL_INT(8) ; my address is 332
MAKE_LITERAL_INT(9) ; my address is 341
MAKE_LITERAL_PAIR(const_tbl + 341, const_tbl + 1) ; my address is 350
MAKE_LITERAL_PAIR(const_tbl + 332, const_tbl + 350) ; my address is 367
MAKE_LITERAL_PAIR(const_tbl + 323, const_tbl + 367) ; my address is 384
MAKE_LITERAL_PAIR(const_tbl + 314, const_tbl + 384) ; my address is 401
MAKE_LITERAL_PAIR(const_tbl + 140, const_tbl + 401) ; my address is 418
MAKE_LITERAL_STRING "quote" ; my address is 435
MAKE_LITERAL_SYMBOL(const_tbl + 435) ; my address is 449
MAKE_LITERAL_STRING "hgeed" ; my address is 458
MAKE_LITERAL_SYMBOL(const_tbl + 458) ; my address is 472
MAKE_LITERAL_PAIR(const_tbl + 472, const_tbl + 1) ; my address is 481
MAKE_LITERAL_PAIR(const_tbl + 449, const_tbl + 481) ; my address is 498
MAKE_LITERAL_PAIR(const_tbl + 498, const_tbl + 401) ; my address is 515
MAKE_LITERAL_PAIR(const_tbl + 140, const_tbl + 515) ; my address is 532
MAKE_LITERAL_STRING " 
 	        sdfdsfds345345      dfsdfds               
  hello                
 	  
 dfdsfds 445 fgfdgfd    " ; my address is 549
MAKE_LITERAL_INT(4543564363) ; my address is 670
MAKE_LITERAL_INT(33) ; my address is 679
MAKE_LITERAL_INT(566) ; my address is 688
MAKE_LITERAL_INT(66) ; my address is 697
MAKE_LITERAL_INT(74) ; my address is 706
MAKE_LITERAL_VECTOR const_tbl + 140, const_tbl + 314, const_tbl + 706, const_tbl + 697, const_tbl + 679, const_tbl + 688, const_tbl + 679 ; my address is 715
...
user_code:
	...
	mov rax, const_tbl + 88 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 97 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 131 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 149 ; Const 
    call write_sob_if_not_void
	...
	mov rax, const_tbl + 140 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 149 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 281 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 715 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 305 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 418 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 549 ; Const 
    call write_sob_if_not_void
	...
	mov rax, const_tbl + 532 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 549 ; Const 
    call write_sob_if_not_void

	mov rax, const_tbl + 670 ; Const 
    call write_sob_if_not_void
	add rsp, 4*8 
	pop rbp 
	ret 
