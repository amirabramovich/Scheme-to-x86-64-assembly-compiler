...
MAKE_LITERAL_INT(2) ; my address is 17
MAKE_LITERAL_STRING "x2" ; my address is 26
MAKE_LITERAL_STRING "y2" ; my address is 37
MAKE_LITERAL_INT(6) ; my address is 48
MAKE_LITERAL_INT(7) ; my address is 57
MAKE_LITERAL_INT(8) ; my address is 66
MAKE_LITERAL_STRING "x3" ; my address is 75
MAKE_LITERAL_STRING "y3" ; my address is 86
MAKE_LITERAL_INT(11) ; my address is 97
MAKE_LITERAL_INT(12) ; my address is 106
MAKE_LITERAL_INT(13) ; my address is 115
MAKE_LITERAL_INT(14) ; my address is 124
MAKE_LITERAL_INT(15) ; my address is 133
MAKE_LITERAL_INT(0) ; my address is 142
MAKE_LITERAL_INT(32) ; my address is 151
MAKE_LITERAL_INT(4) ; my address is 160
MAKE_LITERAL_INT(56) ; my address is 169
MAKE_LITERAL_INT(865) ; my address is 178
MAKE_LITERAL_INT(3) ; my address is 187
MAKE_LITERAL_INT(566) ; my address is 196
MAKE_LITERAL_INT(43) ; my address is 205
MAKE_LITERAL_INT(56674566) ; my address is 214
MAKE_LITERAL_STRING "x4" ; my address is 223
MAKE_LITERAL_STRING "y4" ; my address is 234
MAKE_LITERAL_INT(5) ; my address is 245
MAKE_LITERAL_STRING "x5" ; my address is 254
MAKE_LITERAL_STRING "append" ; my address is 265
MAKE_LITERAL_STRING "y5" ; my address is 280
MAKE_LITERAL_STRING "x6" ; my address is 291
MAKE_LITERAL_STRING "x1" ; my address is 302
...
user_code:
	...
	mov rax, MAGIC ; Applic 
	push rax ; push magic to stack 
	mov rax, const_tbl + 66 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 57 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 48 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 245 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 160 ; Const 
	push rax ; push arg 
	...
	mov rax, MAGIC ; Applic 
	push rax ; push magic to stack 
	mov rax, const_tbl + 214 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 205 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 196 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 187 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 178 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 169 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 160 ; Const 
	push rax ; push arg 
	...
	mov rax, const_tbl + 160 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 142 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 187 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 133 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 124 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 115 ; Const 
	push rax ; push arg 
	mov rax, const_tbl + 106 ; Const 
	push rax ; push arg 
